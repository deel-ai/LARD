...
class ScenarioConfig:
    def __init__(self, airports_runways=None, airport=None, runway=None, scenario_dir=None, yaml_file=None, runways_database_file="data/filtered_runways_database_Final.json"):
        """
        ...
        if yaml_file is not None:
            ...
            for airport, runways in airports_runways.items():
                if not runways:
                    airports_runways[airport] = list(runways_db[airport].keys())
        ...
        self.runways_database = runways_database_file
